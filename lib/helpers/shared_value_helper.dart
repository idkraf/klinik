...
// social login start
final SharedValue<bool> allow_multivendor = SharedValue(
  value: false, // initial value
  key: "system_shop", // disk storage key for shared_preferences
);
...
final SharedValue<String> referred_by = SharedValue(
  value: "", // initial value
...
final SharedValue<String> referral_code = SharedValue(
  value: "", // initial value
  key: "referral_code", // disk storage key for shared_preferences
);
...
final SharedValue<bool> affiliate_system_addon_installed = SharedValue(
  value: false, // initial value
  key: "affiliate_system_addon_installed", // disk storage key for shared_preferences
);
...
final SharedValue<String> club_point_convert_rate = SharedValue(
  value: "", // initial value
  key: "club_point_convert_rate", // disk storage key for shared_preferences
);