...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(217, 169, 26, 1.0);
  ...
  static Color splash_screen_color = Color.fromRGBO(50, 42, 40, 1.0); // if not sure , use the same color as accent color
