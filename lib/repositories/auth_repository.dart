...
import 'package:klinikkecantikan/data_model/login_response.dart';
import 'package:klinikkecantikan/data_model/logout_response.dart';
import 'package:klinikkecantikan/data_model/signup_response.dart';
import 'package:klinikkecantikan/data_model/resend_code_response.dart';
import 'package:klinikkecantikan/data_model/confirm_code_response.dart';
import 'package:klinikkecantikan/data_model/password_forget_response.dart';
import 'package:klinikkecantikan/data_model/password_confirm_response.dart';
import 'package:klinikkecantikan/data_model/user_by_token.dart';
import 'package:flutter/foundation.dart';
import 'dart:convert';
import 'package:klinikkecantikan/helpers/shared_value_helper.dart';

import '../data_model/cek_referral_response.dart';

class AuthRepository {

  Future<CekReferralResponse> cekReferralResponse({reff_id}) async {
    Uri url = Uri.parse("${AppConfig.BASE_URL}/auth/cek-referral?referral_code=${reff_id}");
    final response = await http.get(url);
    print(response.body.toString());
    return cekReferralResponseFromJson(response.body);
  }
  ...
  Future<LoginResponse> getSocialLoginResponse(String social_provider,
