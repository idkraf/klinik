...
import 'package:klinikkecantikan/data_model/conversation_response.dart';
import 'package:klinikkecantikan/data_model/message_response.dart';
import 'package:klinikkecantikan/data_model/conversation_create_response.dart';
...
class ChatRepository {
  ...
  Future<MessageResponse> getInserMessageResponse(
      {conversation_id, required String message}) async {
  ...
  Future<MessageResponse> getNewMessageResponse(
      {conversation_id, last_message_id}) async {
    Uri url = Uri.parse(
