...
import 'package:klinikkecantikan/screens/change_language.dart';
import 'package:klinikkecantikan/screens/filter.dart';
import 'package:klinikkecantikan/screens/main.dart';
import 'package:klinikkecantikan/screens/messenger_list.dart';
...
import 'package:klinikkecantikan/screens/profile_edit.dart';
              ...
              child: InkWell(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      AppLocalizations.of(context)!.refund_request_screen_refund_requests,
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          color: MyTheme.dark_font_grey, fontSize: 12),
                    )
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Visibility(
            visible: affiliate_system_addon_installed.$,
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Container(
                  ...
                  child: TextButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context)!.affiliate_system,
                          textAlign: TextAlign.center,
                          style:
                          TextStyle(color: MyTheme.dark_font_grey, fontSize: 12),
                        )
