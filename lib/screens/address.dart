...
import 'package:klinikkecantikan/data_model/state_response.dart';
...
import '../data_model/kabupaten_response.dart';
import '../data_model/kecamatan_model.dart';
...
class _AddressState extends State<Address> {
  ...
  ProvinceModel? _selected_provinsi;
  KabupatenModel? _selected_kabupaten;
  KecamatanModel? _selected_kecamatan;
  ...
  List<TextEditingController> _provinsiControllerListForUpdate = [];
  List<TextEditingController> _kabupatenControllerListForUpdate = [];
  List<TextEditingController> _kecamatanControllerListForUpdate = [];
  ...
  List<ProvinceModel> _selected_provinsi_list_for_update = [];
  List<KabupatenModel> _selected_kabupaten_list_for_update = [];
  List< KecamatanModel> _selected_kecamatan_list_for_update = [];
  ...
  fetchShippingAddressList() async {
    ...
    if (_shippingAddressList.length > 0) {
      ...
      _shippingAddressList.forEach((address) {
        ...
        _provinsiControllerListForUpdate
          .add(TextEditingController(text: address.state));
        _kabupatenControllerListForUpdate
            .add(TextEditingController(text: address.city));
        _kecamatanControllerListForUpdate
            .add(TextEditingController(text: address.kec));
        ...
        _selected_provinsi_list_for_update.add(ProvinceModel(provinceId: address.state_id.toString(), province: address.state));
        _selected_kabupaten_list_for_update.add(KabupatenModel(cityId: address.city_id.toString(), provinceId: address.state_id.toString(), province: address.state, type: address.type, cityName: address.city, postalCode: address.postal_code));
        _selected_kecamatan_list_for_update.add(KecamatanModel(subdistrictId: address.kec_id.toString(), provinceId: address.state_id.toString(), province: address.state, cityId: address.city_id.toString(), city: address.city, type: address.type, subdistrictName: address.kec));
      });
  ...
  reset() {
    ...
    _provinsiControllerListForUpdate.clear();
    _kabupatenControllerListForUpdate.clear();
    _kecamatanControllerListForUpdate.clear();


    _selected_city_list_for_update.clear();
    _selected_state_list_for_update.clear();

    _selected_provinsi_list_for_update.clear();
    _selected_kabupaten_list_for_update.clear();
    _selected_kecamatan_list_for_update.clear();
  ...
  onAddressAdd(context) async {
    ...
    var addressAddResponse = await AddressRepository().getAddressAddResponse(
        address: address,
        type: _selected_kabupaten!.type,
        country_id: _selected_country!.id!,
        state_id: int.parse(_selected_provinsi!.provinceId),
        state: _selected_provinsi!.province,
        city_id: int.parse(_selected_kabupaten!.cityId),
        city: _selected_kabupaten!.cityName,
        kec_id:  int.parse(_selected_kecamatan!.subdistrictId),
        kec: _selected_kecamatan!.subdistrictName,
  ...
  onAddressAddRajaOngkir(context) async {
    var address = _addressController.text.toString();
    var postal_code = _postalCodeController.text.toString();
    var phone = _phoneController.text.toString();
    ...
    if (_selected_provinsi == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.address_screen_select_provinsi,
          gravity: Toast.center,
          duration: Toast.lengthLong);
      return;
    }

    if (_selected_kabupaten == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.address_screen_select_kabupaten,
          gravity: Toast.center,
          duration: Toast.lengthLong);
      return;
    }

    if (_selected_kecamatan == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.address_screen_select_kecamatan,
          gravity: Toast.center,
          duration: Toast.lengthLong);
      return;
    }
  ...
  onAddressUpdateRajaOngkir(context, index, id) async {
    ...
    if (_selected_provinsi_list_for_update[index] == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.address_screen_select_provinsi,
          gravity: Toast.center,
          duration: Toast.lengthLong);
    ...
    if (_selected_kabupaten_list_for_update[index] == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.address_screen_select_kabupaten,
          gravity: Toast.center,
          duration: Toast.lengthLong);
    ...
    if (_selected_kecamatan_list_for_update[index] == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.address_screen_select_kecamatan,
          gravity: Toast.center,
          duration: Toast.lengthLong);
    ...
    var addressUpdateResponse = await AddressRepository()
        ...
        id: id,
        address: address,
        type: _selected_kabupaten_list_for_update[index].type,
        country_id: _selected_country_list_for_update[index].id!,
        state_id: int.parse(_selected_provinsi_list_for_update[index].provinceId),
        state: _selected_provinsi_list_for_update[index].province,
        city_id: int.parse(_selected_kabupaten_list_for_update[index].cityId),
        city: _selected_kabupaten_list_for_update[index].cityName,
        kec_id: int.parse(_selected_kecamatan_list_for_update[index].subdistrictId),
        kec: _selected_kecamatan_list_for_update[index].subdistrictName,
        postal_code: postal_code,
        phone: phone);
  ...
  //  }
    ...
    if (_selected_provinsi_list_for_update[index] == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.address_screen_no_kabupaten_available,
          gravity: Toast.center,
          duration: Toast.lengthLong);
      return;
    }
    ...
    if (_selected_kecamatan_list_for_update[index] == null) {
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.address_screen_no_kecamatan_available,
          gravity: Toast.center,
          duration: Toast.lengthLong);
      return;
    }
  ...
  onSelectCountryDuringUpdate(index, country, setModalState) {
   ...
   // _selected_city_list_for_update[index] = null;
    ...
    setModalState(() {
      ...
      _provinsiControllerListForUpdate[index].text = "";
      _kabupatenControllerListForUpdate[index].text = "";
      _kecamatanControllerListForUpdate[index].text = "";
    });
  }

  onSelectProvinsiDuringAdd(ProvinceModel state, setModalState) {
    if (_selected_provinsi != null && state.provinceId == _selected_provinsi!.provinceId) {
      setModalState(() {
        _provinsiController.text = state.province;
      });
      return;
    }
    _selected_provinsi = state;
    _selected_kabupaten = null;
    _selected_kecamatan = null;
    setState(() {});
    setModalState(() {
      _provinsiController.text = state.province;
  ...
  onSelectKabupatenDuringAdd(KabupatenModel state, setModalState) {
    if (_selected_kabupaten != null && state.cityId == _selected_kabupaten!.cityId) {
      setModalState(() {
        _kabupatenController.text = state.cityName;
      });
      return;
    }
    _selected_kabupaten = state;
    _selected_kecamatan = null;
    setState(() {});
    setModalState(() {
     // _provinsiController.text = state.province;
  ...
  onSelectKecamatanDuringAdd(KecamatanModel state, setModalState) {
    if (_selected_kecamatan != null && state.subdistrictId == _selected_kecamatan!.cityId) {
      setModalState(() {
        _kecamatanController.text = state.subdistrictName;
      });
      return;
    }
    _selected_kecamatan = state;
    setState(() {});
    setModalState(() {
      // _provinsiController.text = state.province;
      //_kabupatenController.text = state.cityName;
  ...
  onSelectProvinsiDuringUpdate(index, provinsi, setModalState) {
    if (_selected_provinsi_list_for_update[index] != null && provinsi.provinceId == _selected_provinsi_list_for_update[index].provinceId) {
      setModalState(() {
        _provinsiControllerListForUpdate[index].text = provinsi.province;
      });
      return;
    }
    _selected_provinsi_list_for_update[index] = provinsi;
    setModalState(() {
      _provinsiControllerListForUpdate[index].text = provinsi.province;
    });
  }

  onSelectKabupatenDuringUpdate(index, KabupatenModel kab, setModalState) {
    if (_selected_kabupaten_list_for_update[index] != null &&   kab.cityId == _selected_kabupaten_list_for_update[index].cityId) {
      setModalState(() {
        _kabupatenControllerListForUpdate[index].text = kab.cityName;
      });
      return;
    }
    _selected_kabupaten_list_for_update[index] = kab;
    setModalState(() {
      _kabupatenControllerListForUpdate[index].text = kab.cityName;
    });
  }

  onSelectKecamatanDuringUpdate(index, KecamatanModel kab, setModalState) {
    if (_selected_kecamatan_list_for_update[index] != null &&   kab.cityId == _selected_kecamatan_list_for_update[index].cityId) {
      setModalState(() {
        _kecamatanControllerListForUpdate[index].text = kab.subdistrictName;
      });
      return;
    }
    _selected_kecamatan_list_for_update[index] = kab;
    setModalState(() {
      _kecamatanControllerListForUpdate[index].text = kab.subdistrictName;
    });
  }
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          child: TypeAheadField(
                            ...
                            loadingBuilder: (context) {
                              return Container(
                                ...
                                child: Center(
                                    child: Text(
                                        AppLocalizations.of(context)!.address_screen_loading_countries,
                                        style: TextStyle(
                            ...
                            noItemsFoundBuilder: (context) {
                              return Container(
                                ...
                                child: Center(
                                    child: Text(
                                        AppLocalizations.of(context)!.address_screen_no_country_available,
                                        style: TextStyle(
                                            color: MyTheme.medium_grey))),
                              );
                            },
                            ...
                            textFieldConfiguration: TextFieldConfiguration(
                              ...
                              decoration: buildAddressInputDecoration(context,  AppLocalizations.of(context)!.address_screen_enter_country),
                            ),
                          ),
                        ),
                      ),
                      Visibility(
                        visible: !negara.contains("Indonesia"),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TypeAheadField(
                                  suggestionsCallback: (name) async {
                                    if (_selected_country == null) {
                                      var stateResponse = await AddressRepository().getStateListByCountry(); // blank response
                                  ...
                                  noItemsFoundBuilder: (context) {
                                    return Container(
                                      height: 50,
                                      child: Center(
                                          child: Text(AppLocalizations.of(context)!.address_screen_no_state_available,style: TextStyle(color: MyTheme.medium_grey))),
                                    );
                                  },
                                  ...
                                  textFieldConfiguration: TextFieldConfiguration(
                                    ...
                                    decoration: buildAddressInputDecoration(context, AppLocalizations.of(context)!.address_screen_enter_state),
                                  ),
                                ),
                              ),
                            ),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TypeAheadField(
                                  suggestionsCallback: (name) async {
                                    if (_selected_state == null) {
                                      var cityResponse = await AddressRepository().getCityListByState(); // blank response
                                      return cityResponse.cities!;
                                      //var cityResponse = await AddressRepository().getKabupaten(); // blank response
                                      //return cityResponse.states!;
                                    }
                                    var cityResponse = await AddressRepository().getCityListByState(state_id: _selected_state!.id, name: name);
                                    return cityResponse.cities!;
                                    //  var cityResponse = await AddressRepository().getKabupaten(
                                    //  prov_id: _selected_country!.id,
                                    //);
                                    //  return cityResponse.states!;
                                  },
                                  loadingBuilder: (context) {
                                    return Container(
                                      ...
                                      child: Center(
                                          child: Text(
                                              AppLocalizations.of(context)!.address_screen_loading_cities,
                                              style: TextStyle(
                                                  color: MyTheme.medium_grey))),
                                    );
                                  },
                                  ...
                                  noItemsFoundBuilder: (context) {
                                    return Container(
                                      ...
                                      child: Center(
                                          child: Text(
                                              AppLocalizations.of(context)!.address_screen_no_city_available,
                                              style: TextStyle(
                                                  color: MyTheme.medium_grey))),
                                    );
                                  },
                                  ...
                                  textFieldConfiguration: TextFieldConfiguration(
                                    ...
                                    decoration: buildAddressInputDecoration(context, AppLocalizations.of(context)!.address_screen_enter_city),
                                  ),
                                ),
                              ),
                            ),
                      ...
                      Visibility(
                          ...
                          child: Column(children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.only(bottom: 8.0),
                              child: Text(
                                  "${AppLocalizations.of(context)!.address_screen_provinsi} *",
                                  style: TextStyle(
                                      color: MyTheme.font_grey, fontSize: 12)),
                            ),
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TypeAheadField(
                                  suggestionsCallback: (name) async {
                                    var stateResponse = await AddressRepository().getProvinsi();
                                    return stateResponse.states!;
                                  },
                                  loadingBuilder: (context) {
                                    return Container(
                                      ...
                                      child: Center(
                                          child: Text(
                                              AppLocalizations.of(context)!.address_screen_loading_provinsi,
                                              style: TextStyle(color: MyTheme.medium_grey)
                                          )
                                      ),
                                    );
                                  ...
                                  noItemsFoundBuilder: (context) {
                                    return Container(
                                      height: 50,
                                      child: Center(
                                          child: Text(AppLocalizations.of(context)!.address_screen_no_provinsi_available,style: TextStyle(color: MyTheme.medium_grey))),
                                    );
                                  },
                                  onSuggestionSelected: (state) {
                                    onSelectProvinsiDuringAdd(state, setModalState);
                                  },
                                  textFieldConfiguration: TextFieldConfiguration(
                                    onTap: () {},
                                    //autofocus: true,
                                    ...
                                    decoration: buildAddressInputDecoration(context, AppLocalizations.of(context)!.address_screen_enter_provinsi),
                                  ),
                                ),
                              ),
                            ),
                            ...
                            Padding(
                              padding: const EdgeInsets.only(bottom: 8.0),
                              child: Text(
                                  "${AppLocalizations.of(context)!.address_screen_kabupaten} *",
                                  style: TextStyle(
                                      color: MyTheme.font_grey, fontSize: 12)),
                            ),
                            Padding(
                                ...
                                child: TypeAheadField(
                                  suggestionsCallback: (name) async {
                                    if (_selected_provinsi == null) {
                                      ...
                                      var cityResponse = await AddressRepository().getKabupaten(
                                      prov_id: _selected_provinsi!.provinceId,
                                    );
                                      return cityResponse.states!;
                                  },
                                  loadingBuilder: (context) {
                                    return Container(
                                      ...
                                      child: Center(
                                          child: Text(
                                              AppLocalizations.of(context)!.address_screen_loading_kabupaten,
                                              style: TextStyle(
                                                  color: MyTheme.medium_grey))),
                                    );
                                  },
                                  ...
                                  onSuggestionSelected: (city) {
                                    onSelectKabupatenDuringAdd(city, setModalState);
                                  },
                                  textFieldConfiguration: TextFieldConfiguration(
                                    onTap: () {},
                                    //autofocus: true,
                                    ...
                                    decoration: buildAddressInputDecoration(context, AppLocalizations.of(context)!.address_screen_enter_kabupaten),
                                  ),
                                ),
                              ),
                            ),
                            ...
                            Padding(
                              padding: const EdgeInsets.only(bottom: 8.0),
                              child: Text(
                                  "${AppLocalizations.of(context)!.address_screen_kecamatan} *",
                                  style: TextStyle(
                                      color: MyTheme.font_grey, fontSize: 12)),
                            ),
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TypeAheadField(
                                  suggestionsCallback: (name) async {
                                    if (_selected_kabupaten== null) {
                                      var kecResponse = await AddressRepository().getKecamatan(); // blank response
                                      return kecResponse.states!;
                                    }
                                      var cityResponse = await AddressRepository().getKecamatan(
                                      kab_id: _selected_kabupaten!.cityId,
                                    );
                                      return cityResponse.states!;
                                  },
                                  loadingBuilder: (context) {
                                    return Container(
                                      ...
                                      child: Center(
                                          child: Text(
                                              AppLocalizations.of(context)!.address_screen_loading_kecamatan,
                                              style: TextStyle(
                                                  color: MyTheme.medium_grey))),
                                    );
                                  },
                                  itemBuilder: (context, kec) {
                                    //print(suggestion.toString());
                                    return ListTile(
                                      dense: true,
                                      title: Text(
                                  ...
                                  onSuggestionSelected: (city) {
                                    onSelectKecamatanDuringAdd(city, setModalState);
                                  },
                                  textFieldConfiguration: TextFieldConfiguration(
                                    onTap: () {},
                                    //autofocus: true,
                                    ...
                                    decoration: buildAddressInputDecoration(context, AppLocalizations.of(context)!.address_screen_enter_kecamatan),
                                  ),
                                ),
                              ),
                            ),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: Text(
                            AppLocalizations.of(context)!.address_screen_postal_code,
                            style: TextStyle(
                                color: MyTheme.font_grey, fontSize: 12)),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            autofocus: false,
                            decoration: buildAddressInputDecoration(context, AppLocalizations.of(context)!.address_screen_enter_postal_code),
                          ),
                        ),
                      ),
                      Padding(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            autofocus: false,
                            decoration: buildAddressInputDecoration(context, AppLocalizations.of(context)!.address_screen_enter_phone),
                          ),
                        ),
                      )
                    ],
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          negara.contains("Indonesia") ?
                          onAddressAddRajaOngkir(context)
                                ...
                                child: TypeAheadField(
                                  ...
                                  noItemsFoundBuilder: (context) {
                                    return Container(
                                      ...
                                      child: Center(
                                          child: Text(
                                              AppLocalizations.of(context)!.address_screen_no_provinsi_available,
                                              style: TextStyle(
                                                  color: MyTheme.medium_grey))),
                                    );
                                  },
                                  onSuggestionSelected: (state) {
                                    onSelectProvinsiDuringUpdate(index, state, setModalState);
                                  },
                                  textFieldConfiguration: TextFieldConfiguration(
                                    onTap: () {},
                                    //autofocus: true,
                                    controller: _provinsiControllerListForUpdate[index],
                                    onSubmitted: (txt) {
                                      // _searchKey = txt;
                                      // setState(() {});
                                      // _onSearchSubmit();
                              ...
                              child: Container(
                                ...
                                child: TypeAheadField(
                                  suggestionsCallback: (name) async {
                                    ...
                                    var cityResponse = await AddressRepository().getKabupaten(
                                      prov_id:_selected_provinsi_list_for_update[index].provinceId,
                                    );
                                    return cityResponse.states!;
                                  },
                                  loadingBuilder: (context) {
                                  ...
                                  onSuggestionSelected: (kabupaten) {
                                    onSelectKabupatenDuringUpdate(
                                        index, kabupaten, setModalState);
                                  },
                                  textFieldConfiguration: TextFieldConfiguration(
                                    onTap: () {},
                                    //autofocus: true,
                                    controller: _kabupatenControllerListForUpdate[index],
                                    onSubmitted: (txt) {
                                      // keep blank
                                    },
                                    decoration: buildAddressInputDecoration(context,  AppLocalizations.of(context)!.address_screen_enter_kabupaten),
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: TypeAheadField(
                                  suggestionsCallback: (name) async {
                                    if (_selected_kabupaten_list_for_update[index] == null) {
                                      var cityResponse = await AddressRepository().getKecamatan(); // blank response
                                      return cityResponse.states!;
                                    }
                                    var cityResponse = await AddressRepository().getKecamatan(
                                        kab_id: _selected_kabupaten_list_for_update[index].cityId);
                                    return cityResponse.states!;
                                  },
                                  loadingBuilder: (context) {
                                    return Container(
                                  ...
                                  onSuggestionSelected: (city) {
                                    onSelectKecamatanDuringUpdate(
                                        index, city, setModalState);
                                  },
                                  textFieldConfiguration: TextFieldConfiguration(
                                    onTap: () {},
                                    //autofocus: true,
                                    controller: _kecamatanControllerListForUpdate[index],
                                    onSubmitted: (txt) {
                                      // keep blank
                                    },
                                    decoration: buildAddressInputDecoration(context,  AppLocalizations.of(context)!.address_screen_enter_kecamatan),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextButton(
                        ...
                        child: Text(
                          AppLocalizations.of(context)!.common_update_in_all_capital,
                          style: TextStyle(
                              color: Colors.white,
                              fontSize: 13,
                              fontWeight: FontWeight.w600),
                        ...
                        onPressed: () {
                          negara.contains("Indonesia")?
                          onAddressUpdateRajaOngkir(context, index, _shippingAddressList[index].id)
          ...
          child: Row(
            ...
            children: [
              TextButton(
                ...
                child: Text(
                  AppLocalizations.of(context)!.address_screen_back_to_shipping_info,
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                      fontWeight: FontWeight.w600),
