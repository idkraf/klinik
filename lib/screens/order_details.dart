...
import 'package:klinikkecantikan/repositories/order_repository.dart';
...
import 'package:klinikkecantikan/repositories/refund_request_repository.dart';
import 'package:klinikkecantikan/screens/refund_request.dart';
import 'dart:async';
...
class _OrderDetailsState extends State<OrderDetails> {
  ...
  List<dynamic> _orderedAwbList = [];
  var _awbHistori = null;
  bool _orderAwbInit = false;
  ...
  fetchAwb() async{
    var orderAwbResponse = await OrderRepository().getAwb(kurir:_orderDetails.carrier.toString(), awb: _orderDetails.tracking_code.toString());
    if(orderAwbResponse.status == 200){
      _orderedAwbList.addAll(orderAwbResponse.awb!);
      _awbHistori = orderAwbResponse.deliveryInfo;
      _orderAwbInit = true;
      onTapAwb();
    }
    //setState(() {});
  ...
  onPressOfflinePaymentButton() {
    print("cek total: ${_orderDetails.plane_grand_total.toDouble()}");
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return Checkout(
        ...
        rechargeAmount: _orderDetails.plane_grand_total.toDouble(),
                ...
                children: [
                  ...
                  Padding(
                      ...
                      child:Column(
                         crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text( "Penerima: ${_awbHistori.pod_receiver}",
                                    overflow: TextOverflow.ellipsis,
                                    maxLines: 2,
                                    style: TextStyle(
                                        color: MyTheme.font_grey,
                                        fontSize: 12)),
                            Text( "Tgl: ${_awbHistori.pod_date}  ",
                                overflow: TextOverflow.ellipsis,
                                maxLines: 2,
                                style: TextStyle(
                                    color: MyTheme.font_grey,
                                    fontSize: 12)),
                            Text( "Jam:${_awbHistori.pod_time} ",
                                overflow: TextOverflow.ellipsis,
                                maxLines: 2,
                                style: TextStyle(
                                    color: MyTheme.font_grey,
                  ...
                  ListView.separated(
                    ...
                    itemCount: _orderedAwbList.length,
                    scrollDirection: Axis.vertical,
                    physics: NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    itemBuilder: (context, index) {
                      return buildOrderedAwbItemsCard(index);
                    },
                  ),
                ]
              )
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text(
                                AppLocalizations.of(context)!.order_details_screen_refund_product_name,
                                style: TextStyle(
                                    color: MyTheme.font_grey, fontSize: 12)),
                            Container(
                              width: 225,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text(
                                AppLocalizations.of(context)!.order_details_screen_refund_order_code,
                                style: TextStyle(
                                    color: MyTheme.font_grey, fontSize: 12)),
                            Padding(
                              padding: const EdgeInsets.only(left: 8.0),
                          ...
                          children: [
                            ...
                            _showReasonWarning
                                ? Padding(
                                    ...
                                    child: Text(
                                        AppLocalizations.of(context)!.order_details_screen_refund_reason_empty_warning,
                                        style: TextStyle(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Text(_orderDetails.shipping_type.toString() == "pickup_point" ? "Jemput sendiri" : "Resi: ",
                  style: TextStyle(
                      color: MyTheme.font_grey,
                      fontSize: 13,
                      fontWeight: FontWeight.w600),
                ...
                Spacer(),
                _orderDetails.carrier_id!=0 ? Text(
                  _orderDetails.tracking_code != null ? _orderDetails.tracking_code.toString() : "Dalam Proses",
                  style: TextStyle(
                      color: MyTheme.font_grey,
                      fontSize: 13,
                      fontWeight: FontWeight.w600),
            ...
            _orderDetails.pickupPoint != null ? Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                     _orderDetails.pickupPoint.name,
                    style: TextStyle(
                        color: MyTheme.font_grey,
                        fontSize: 13,
                        fontWeight: FontWeight.w600),
                  ...
                  Text(
                    _orderDetails.pickupPoint.address,
                    style: TextStyle(
                        color: MyTheme.font_grey,
                        fontSize: 13,
                        fontWeight: FontWeight.w600),
                  ...
                  Text(
                    _orderDetails.pickupPoint.phone,
                    style: TextStyle(
                        color: MyTheme.font_grey,
                        fontSize: 13,
                        fontWeight: FontWeight.w600),
            ...
            _orderDetails.tracking_code!=null ?
            InkWell(
              onTap: () {
                fetchAwb();
              },
  ...
  buildOrderedAwbItemsCard(index) {
    return Container(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.only(bottom: 8.0),
              child: Text(
                _orderedAwbList[index].manifest_description,
                maxLines: 2,
                style: TextStyle(
                  color: MyTheme.font_grey,
                ),
            ...
            Padding(
              padding: const EdgeInsets.only(bottom: 8.0),
              child: Text(
                "Penerima: ${_orderedAwbList[index].city_name}",
                style: TextStyle(
                  color: MyTheme.font_grey,
                ),
              ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    _orderedAwbList[index].manifest_date,
                    style: TextStyle(
                        color: MyTheme.font_grey,
                        fontSize: 13,
                        fontWeight: FontWeight.w600),
                  ...
                  Spacer(),
                  Text(
                    _orderedAwbList[index].manifest_time,
                    style: TextStyle(
                        color: MyTheme.accent_color,
                        fontSize: 13,
                        fontWeight: FontWeight.w600),
              ...
              ? TextButton(
                  ...
                  child: Text(
                    AppLocalizations.of(context)!
                        .order_details_screen_make_offline_payment, // translate menjadi konfirmasi pembayaran
                    style: TextStyle(color: MyTheme.font_grey),
                  ),
                  onPressed: () {
                    onPressOfflinePaymentButton();
  ...
  Container buildPaymentStatusCheckContainer(String payment_status) {
    return Container(
      ...
      child: Padding(
        ...
        child: Icon(
            payment_status == "paid" ? FontAwesomeIcons.check : FontAwesomeIcons.times,
            color: Colors.white,
            size: 10),
      ),
    );
