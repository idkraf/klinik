...
class _PasswordOtpState extends State<PasswordOtp> {
  ...
  onPressConfirm() async {
    ...
    if (code == "") {
      ...
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.password_otp_screen_password_confirm_warning,
          gravity: Toast.center,
          duration: Toast.lengthLong);
      return;
      ...
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.password_otp_screen_password_match_warning,
          gravity: Toast.center,
          duration: Toast.lengthLong);
      return;
    }
            ...
            Padding(
              ...
              child: Container(
                ...
                child: TextButton(
                  ...
                  child: Text(
                    AppLocalizations.of(context)!.password_otp_screen_back_to_Login,
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 13,
                        fontWeight: FontWeight.w600),
