...
import 'package:klinikkecantikan/repositories/review_repositories.dart';
  ...
  onTapReviewSubmit(context) async {
    ...
    if (myReviewText == "") {
      ToastComponent.showDialog(
          AppLocalizations.of(context)!.product_reviews_screen_review_empty_warning,
                ...
                child: Container(
                  child: RatingBar(
                    ...
                    ratingWidget: RatingWidget(
                      ...
                      empty: FaIcon(FontAwesomeIcons.star,
        ...
        Padding(
          ...
          child: RatingBar.builder(
            ...
            itemBuilder: (context, _) {
              return FaIcon(FontAwesomeIcons.star, color: Colors.amber);
            },
            onRatingUpdate: (rating) {
              setState(() {
                _my_rating = rating;
