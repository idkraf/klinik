...
import 'package:klinikkecantikan/repositories/wallet_repository.dart';
...
import 'package:klinikkecantikan/screens/recharge_wallet.dart';
              ...
              child: Stack(
               /* controller: _mainScrollController,
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(
                          top: 8.0, bottom: 10.0, left: 16.0, right: 16.0),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(
                        top: 120.0, left: 16.0, right: 16.0, bottom: 0.0),
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(children: [
                  Text(
                    "${ AppLocalizations.of(context)!.wallet_screen_last_recharged}",
                    style: TextStyle(
